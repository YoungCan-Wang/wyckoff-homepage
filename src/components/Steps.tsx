...
export default function Steps() {
  ...
  return (
    <section id="start" className="py-24 px-6 border-t border-white/[0.04]">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          {t.steps.items.map((step, i) => (
            <motion.div
              ...
              className="flex items-center gap-6 p-5 rounded-xl border border-white/[0.06] bg-zinc-900/30 hover:border-emerald-500/20 transition-colors group"
            >
              <span className="flex-none text-2xl font-bold text-zinc-800 group-hover:text-emerald-500/30 transition-colors font-mono">
                {step.n}
              </span>
              ...
              <div className="flex-1 min-w-0">
                <code className="block text-sm font-mono text-emerald-400/80 truncate">
                  {step.cmd}
                </code>
              </div>
            </motion.div>
        ...
        <motion.div
          ...
          className="mt-10 rounded-xl border border-white/[0.06] overflow-hidden glow-green"
        >
          <div className="flex items-center gap-1.5 px-4 py-2.5 border-b border-white/[0.04] bg-zinc-900/50">
