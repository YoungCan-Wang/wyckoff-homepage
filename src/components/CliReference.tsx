...
const dashScreens = [
  { key: 'overview', img: `${BASE}screenshots/dashboard-overview.png` },
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            <h3 className="text-lg font-bold text-zinc-800 dark:text-zinc-100 mb-2">
              {t.cli.dashboard.label}
            </h3>
            <p className="text-sm text-zinc-500">{t.cli.dashboard.desc}</p>
          </div>
          ...
          >
            <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden bg-zinc-50 dark:bg-zinc-900/50">
              <div className="flex items-center gap-2 px-4 py-2.5 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#0c0c14]">
                <span className="w-3 h-3 rounded-full bg-red-400" />
                <span className="w-3 h-3 rounded-full bg-yellow-400" />
                <span className="w-3 h-3 rounded-full bg-green-400" />
                <span className="flex-1 text-center text-[11px] text-zinc-500 font-mono truncate">
                  127.0.0.1:8765 — Wyckoff Dashboard
                </span>
              </div>
              <img
                src={dashCurrent.img}
                alt={dashTabs[dashActive].title}
                className="w-full"
                loading="lazy"
              />
            </div>
