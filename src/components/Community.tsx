    ...
    <section className="py-24 px-6 border-t border-zinc-200 dark:border-white/[0.04]">
      ...
      >
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900 font-medium text-sm rounded-lg hover:bg-zinc-800 dark:hover:bg-white transition-colors"
        >
